...
export default function ChangelaporModal() {
    ...
    const { showUpdate, setShowUpdate, dataUpdate, handleUpdate } = useLapor();
    ...
    return (
        <div className="h-screen w-full z-40 fixed inset-0">
            <div onClick={() => setShowUpdate(false)} className="h-full w-full absolute bg-black opacity-50 z-10"></div>
